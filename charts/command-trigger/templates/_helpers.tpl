...
*/}}
{{- define "command-trigger.fullname" -}}
...
Common labels
*/}}
{{- define "command-trigger.labels" -}}
app.kubernetes.io/name: {{ include "command-trigger.name" . }}
helm.sh/chart: {{ include "command-trigger.chart" . }}
